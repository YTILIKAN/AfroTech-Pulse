...
def _run_tests():
    ...
    try:
        ...
        # Test 1 : ins├⌐rer un article et v├⌐rifier qu'il est en base
        sauvegarder_article(
            titre="IA r├⌐volutionne l'agriculture au Kenya",
        ...
        assert row is not None, "Test 1 ECHOUE : article introuvable apr├¿s insertion"
        assert row[0] == "IA r├⌐volutionne l'agriculture au Kenya", "Test 1 ECHOUE : titre incorrect"
        print("Test 1 OK ΓÇö article ins├⌐r├⌐ et retrouv├⌐ en base")
        ...
        print("Test 2 OK ΓÇö article_existe() fonctionne correctement")
...
if __name__ == "__main__":
    creer_base()
    print(f"Base de donn├⌐es '{DB_PATH}' cr├⌐├⌐e/ouverte sans erreur.")
    _run_tests()
